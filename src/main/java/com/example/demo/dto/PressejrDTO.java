...
public class PressejrDTO {
     private String name;
    private String nameFr;
    private String nameEn;

    public Pressejr toPressejr() {
        Pressejr Pressejr = new Pressejr();
        Pressejr.setName(this.getName());
        Pressejr.setNameFr(this.getNameFr());
        Pressejr.setNameEn(this.getNameEn());
        return Pressejr;
    }

    
    public PressejrDTO(final String name, final String nameFr, final String nameEn) {
        this.name = name;
        this.nameEn = nameEn;
        this.nameFr = nameFr;
    }
    ...
    public boolean equals(final Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof PressejrDTO)) {
            return false;
        } else {
            PressejrDTO other = (PressejrDTO)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PressejrDTO;
    }
    ...
    public String toString() {
        return "PressejrDTO(name=" + this.getName()
        + ", nameFr=" + this.getNameFr() // Ajout de nameFr
        + ", nameEn=" + this.getNameEn() // Ajout de nameEn 
        + ")";
    }

    public static class PressejrDTOBuilder {
