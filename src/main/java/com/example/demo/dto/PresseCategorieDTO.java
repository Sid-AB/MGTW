...
public class PresseCategorieDTO {
    ...
    public PresseCategorieDTO(final String name, final String description, final String type) {
        this.name = name;
    ...
    public String toString() {
        ...
        return "PresseCategorieDTO(name=" + var10000 + ", description=" + this.getDescription() + ", type=" + this.getType() + ")";
    }
