...
public class Radio {
    ...
    public String toString() {
        ...
        return "Radio(id=" + var10000 + ", name=" + this.getName() + ", description=" + this.getDescription() + ", adresse=" + this.getAdresse() + ", localisation=" + this.getLocalisation() + ", type=" + this.getType() + ", categorie=" + this.getCategorie() + ", phone=" + this.getPhone() + ", fax=" + this.getFax() + ", email=" + this.getEmail() + ", website=" + this.getWebsite() + ", streaminglink=" + this.getStreaminglink() + ", complexe=" + String.valueOf(this.getComplexe()) + ", caracteristiqueList=" + String.valueOf(this.getCaracteristiqueList()) + ", multimediaList=" + String.valueOf(this.getMultimediaList()) + ", createdAt=" + String.valueOf(this.getCreatedAt()) + ", updatedAt=" + String.valueOf(this.getUpdatedAt()) + ")";
    }

    public Radio(final Long id, final String name, final String description, final String adresse, final String localisation, final String type, final String categorie, final String phone, final String fax, final String email, final String website, final String streaminglink, final Complexe complexe, final List<Caracteristique> caracteristiqueList, final List<Multimedia> multimediaList, final LocalDateTime createdAt, final LocalDateTime updatedAt) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.adresse = adresse;
    ...
    public static class RadioBuilder {
        ...
        public Radio.RadioBuilder description(final String description) {
            this.description = description;
            return this;
        }
        ...
        public Radio build() {
            return new Radio(this.id, this.name, this.description, this.adresse, this.localisation, this.type, this.categorie, this.phone, this.fax, this.email, this.website, this.streaminglink, this.complexe, this.caracteristiqueList, this.multimediaList, this.createdAt, this.updatedAt);
        }

        public String toString() {
            Long var10000 = this.id;
            return "Radio.RadioBuilder(id=" + var10000 + ", name=" + this.name + ", description=" + this.description + ", adresse=" + this.adresse + ", localisation=" + this.localisation + ", type=" + this.type + ", categorie=" + this.categorie + ", phone=" + this.phone + ", fax=" + this.fax + ", email=" + this.email + ", website=" + this.website + ", streaminglink=" + this.streaminglink + ", complexe=" + String.valueOf(this.complexe) + ", caracteristiqueList=" + String.valueOf(this.caracteristiqueList) + ", multimediaList=" + String.valueOf(this.multimediaList) + ", createdAt=" + String.valueOf(this.createdAt) + ", updatedAt=" + String.valueOf(this.updatedAt) + ")";
        }
    }
}
