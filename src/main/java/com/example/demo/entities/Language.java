...
public class Language {
    ...
    public Language(Long id,String name,String nameFr,String nameEn)
    {
        this.id=id;
        this.name=name;
        this.nameFr=nameFr;
    ...
    public String toString() {
        ...
        return "Language(id=" + var10000 + ", name=" + this.getName()
    ...
    public Language(final Long id, final String name, final String nameFr, final String nameEn,
    ...
    public static class LanguageBuilder {
        ...
        public Language.LanguageBuilder id(final Long id) {
            this.id = id;
            return this;
        }

        public Language.LanguageBuilder name(final String name) {
            this.name = name;
            return this;
        }
        public Language.LanguageBuilder nameFr(final String nameFr) {
            this.nameFr = nameFr;
            return this;
        }
        public Language.LanguageBuilder nameEn(final String nameEn) {
            this.nameEn = nameEn;
            return this;
        }

        public Language.LanguageBuilder PresseList(final List<Presse> PresseList) {
            this.PresseList = PresseList;
            return this;
        }

        public Language.LanguageBuilder createdAt(final LocalDateTime createdAt) {
            this.createdAt = createdAt;
            return this;
        }

        public Language.LanguageBuilder updatedAt(final LocalDateTime updatedAt) {
            this.updatedAt = updatedAt;
            return this;
        }

        public Language build() {
            return new Language(this.id, this.name, this.nameFr,
            this.nameEn, this.PresseList, this.createdAt, this.updatedAt);
        }

        public String toString() {
            Long var10000 = this.id;
            return "Language.LanguageBuilder(id=" + var10000 
            + ", name=" + this.name  
            +", nameFr=" + this.nameFr 
            +", nameEn=" + this.nameEn 
