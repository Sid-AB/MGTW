...
public class Pressejr {
    ...
    public static Pressejr.PressejrBuilder builder() {
        return new Pressejr.PressejrBuilder();
    }
    public Pressejr(Long id,String name,String nameFr,String nameEn)
    {
        this.id=id;
        this.name=name;
        this.nameFr=nameFr;
    ...
    public boolean equals(final Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof Pressejr)) {
            return false;
        } else {
            Pressejr other = (Pressejr)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof Pressejr;
    }
    ...
    public String toString() {
        ...
        return "Pressejr(id=" + var10000 + ", name=" + this.getName()
    ...
    public Pressejr(final Long id, final String name, final String nameFr, final String nameEn,
    ...
    public static class PressejrBuilder {
        private Long id;
        private String name;
        ...
        public Pressejr.PressejrBuilder id(final Long id) {
            this.id = id;
            return this;
        }

        public Pressejr.PressejrBuilder name(final String name) {
            this.name = name;
            return this;
        }
        public Pressejr.PressejrBuilder nameFr(final String nameFr) {
            this.nameFr = nameFr;
            return this;
        }
        public Pressejr.PressejrBuilder nameEn(final String nameEn) {
            this.nameEn = nameEn;
            return this;
        }

        public Pressejr.PressejrBuilder PresseList(final List<Presse> PresseList) {
            this.PresseList = PresseList;
            return this;
        }

        public Pressejr.PressejrBuilder createdAt(final LocalDateTime createdAt) {
            this.createdAt = createdAt;
            return this;
        }

        public Pressejr.PressejrBuilder updatedAt(final LocalDateTime updatedAt) {
            this.updatedAt = updatedAt;
            return this;
        }

        public Pressejr build() {
            return new Pressejr(this.id, this.name, this.nameFr,
            this.nameEn, this.PresseList, this.createdAt, this.updatedAt);
        }

        public String toString() {
            Long var10000 = this.id;
            return "Pressejr.PressejrBuilder(id=" + var10000 
            + ", name=" + this.name  
            +", nameFr=" + this.nameFr 
            +", nameEn=" + this.nameEn 
