...
public class DataInit implements CommandLineRunner {
    ...
    @Override
     ...
     {CategoriePress Cate1=new CategoriePress((long)1,"ثقافي","Culture","Cultural");
     CategoriePress Cate2=new CategoriePress((long)2,"إقتصادي","Economie","Economic");
     CategoriePress Cate3=new CategoriePress((long)3,"عام","publique","public");
     CategoriePress Cate4=new CategoriePress((long)4,"رياضي","sprot","sport");
     CategoriePress Cate5=new CategoriePress((long)5,"صحي","Santé","Hygienic");
     CategoriePress Cate6=new CategoriePress((long)6,"سياحي","Touristique","Tourist");
     CategoriePress Cate7=new CategoriePress((long)7,"فلاحي","Paysan","Peasant");
     CategoriePress Cate8=new CategoriePress((long)8,"تكنولوجي","Technologique","Technology");
